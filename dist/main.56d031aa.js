...
},{"process":"node_modules/process/browser.js"}],"node_modules/marked/lib/marked.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/**
...
renderer.link = function (href, title, text) {
  var link = _marked.default.Renderer.prototype.link.call(this, href, title, text);
...
var speedCode = 1;
var duration = 80;
var speed_text = (0, _jquery.default)('.speed_text');
var speed_icon = (0, _jquery.default)('.speed_icon');
(0, _jquery.default)('#speed').click(function () {
  speedCode += 1;
  if (speedCode > 3) {
    speedCode = 1;
  }
...
function writeCode(prefix, code) {
  var domCode = document.querySelector('#code_body');
  var styleTags = document.querySelector('#styleTags');
  var n = 0;
...
function adjustResume() {
  return new Promise(function (resolve, reject) {
    ...
    writeCode(code_ready, code_marked).then(function () {
      structureResume();
...
function skipAll() {
  return new Promise(function (resolve) {
    setTimeout(function () {
      window.clearTimeout(codeId);
      resolve();
      (0, _jquery.default)('.skip').remove();
    }, 0);
  });
}
function structureResume() {
  var paper = (0, _jquery.default)('.paper');
  paper[0].innerHTML = (0, _marked.default)(resume);
  paper.prepend('<div id="information"></div>', '<div id="skills"></div>', '<div id="works"></div>', '<div id="jobs"></div>', '<div id="education"></div>');
  (0, _jquery.default)('#information').append((0, _jquery.default)('h1'), (0, _jquery.default)('p').first());
  (0, _jquery.default)('#skills').append((0, _jquery.default)('h2:contains("技能")'), (0, _jquery.default)('ul').first());
  (0, _jquery.default)('#education').append((0, _jquery.default)('h2:contains("教育")'), (0, _jquery.default)('h3:contains("学院")'), (0, _jquery.default)('p').last(), (0, _jquery.default)('ul').last());
  (0, _jquery.default)('#jobs').append((0, _jquery.default)('h2:contains("工作")'));
  (0, _jquery.default)('h3:contains("公司")').each(function (index, element) {
    (0, _jquery.default)('<div id="experience"></div>').append((0, _jquery.default)(element), (0, _jquery.default)('p').last(), (0, _jquery.default)('ul').last()).appendTo((0, _jquery.default)('#jobs'));
  });
  (0, _jquery.default)('#works').append((0, _jquery.default)('.paper').children().not((0, _jquery.default)('div')));
}
function showFinalResume() {
  var paper = (0, _jquery.default)('.paper');
  var code = (0, _jquery.default)('#code_body');
  ...
  (0, _jquery.default)('#styleTags')[0].innerHTML = code_ready + code_marked + code_beautify_resume;
  code[0].scrollTop = code[0].scrollHeight;
  (0, _jquery.default)('.options').css({
    'width': '23%'
  });
  (0, _jquery.default)('a.downloadResume').addClass('show');
...
},{"jquery":"node_modules/jquery/dist/jquery.js","marked":"node_modules/marked/lib/marked.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
